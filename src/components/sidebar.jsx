  ...
  return (
    <div className="w-64 h-full bg-white border-r border-gray-200 flex flex-col shadow-sm">
      <div className="p-4 space-y-1">
        <div className="flex items-center p-2.5 rounded-lg hover:bg-gray-100 transition-all duration-200 cursor-pointer group">
        ...
        <div>
          ...
          {expandedSection === 'My Team' && (
            <div className="pl-12 pr-4 py-2 bg-gray-50 space-y-2">
              <div className="flex items-center py-2 px-2 text-gray-700 hover:text-blue-600 hover:bg-white rounded-md transition-all duration-200 cursor-pointer group">
