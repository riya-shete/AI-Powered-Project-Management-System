  ...
  return (
    <nav className="flex items-center justify-between w-full px-6 py-3 bg-white border-b border-gray-200 shadow-sm sticky top-0 z-10">
      <div className="flex items-center">
        <div className="flex items-center mr-8 space-x-2">
          <div className="bg-blue-600 p-1.5 rounded-md">
            <img src="https://t3.ftcdn.net/jpg/10/72/44/00/240_F_1072440017_zNNC9vqpxBgm9C2U4qG8d5KrR4KIH6cj.jpg" alt="Logo" className="w-5 h-5" />
          </div>
          <div>
      ...
      <div className="flex items-center space-x-5">
        <button className="text-gray-500 hover:text-blue-600 transition-colors duration-200 relative group">
        ...
        <button className="flex items-center space-x-2 p-1 rounded-full hover:bg-gray-100 transition-colors duration-200">
          <img src="https://t4.ftcdn.net/jpg/09/61/69/71/240_F_961697155_J7ZlI6T87DqEtLIRZoXkdMAMs87VyfAu.jpg" alt="Profile" className="w-8 h-8 rounded-full border-2 border-blue-400" />
